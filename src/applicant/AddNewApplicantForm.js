...
import myclass from '../component/course/CreateCourseForm.module.css'
...
const AddNewApplicantForm = () => {
  ...
  const canSave =
    [fullname, username, phno, street, township, city, gender].every(Boolean) &&
      ...
      <div className={classes.formboldformwrapper}>
        <form onSubmit={onSubmit}>
          ...
          <div className={classes.formboldinputflex}>
            <div>
              <label for="street" className={classes.formboldformlabel}>
                {" "}
                Street{" "}
              </label>
              <input
            ...
            <div>
              <label for="township" className={classes.formboldformlabel}>
                {" "}
                Township{" "}
              </label>
              <input
          ...
          <button type="submit" className={classes.formboldbtn}>
            Create Applicant{" "}
          </button>
